...
window.onload = function setUpCanvas() {
	...
	if (typeof ctx === "undefined") {} // if no context, do nothing
		...
		if (flag_debug == true) {
			console.log("  calling resizeCanvas() from window.onload")
		};
		resizeCanvas(); // size canvas to window
		if (flag_debug == true) {
			console.log("  calling setUpAnimation() from window.onload")
		};
		setUpAnimation(); // perform setup
		if (flag_debug == true) {
			console.log("  calling animate() from window.onload")
		};
...
function setUpAnimation() {
	if (flag_debug == true) {
		console.log("      entering setUpAnimation()")
	};
	...
	if (flag_debug == true) {
		console.log("      " + totalCubes + " cubes pushed")
	};

	lastFrame = Date.now(); // get initial timing point

	if (flag_debug == true) {
		console.log("      leaving setUpAnimation()")
	};
	if (flag_trigger_debugger_verbose == true) {
		debugger;
	}
}
...
var worldTransform = [],
	...
	screenTransform = [];
// camera properties
var cameraPosition = Sylvester.Vector.create([0, -300, -4000]), // xyz position
	cameraRotation = Sylvester.Vector.create([0, 0, 0]); // xyz rotation
if (flag_debug_verbose == true) {
...
// temp matrices
var tempMat1 = Sylvester.Matrix.I(4, 4),
	tempMat2 = Sylvester.Matrix.I(4, 4),
	tempMat3 = Sylvester.Matrix.I(4, 4),
	tempMat4 = Sylvester.Matrix.I(4, 4),
	result = Sylvester.Matrix.I(4, 4);
// temp vertices
var tempVert1 = Sylvester.Vector.create([0, 0, 0]),
	tempVert2 = Sylvester.Vector.create([0, 0, 0]),
	tempVert3 = Sylvester.Vector.create([0, 0, 0]),
	eyeVector = Sylvester.Vector.create([0, 0, 0]);
...
function buildCameraTransform() {
	if (flag_debug == true) {
		console.log("entering buildCameraTransform()")
	};
	...
	// rotation on x axis:
	tempMat1.elements[0][0] = 1;
	tempMat1.elements[0][1] = 0;
	tempMat1.elements[0][2] = 0;
	tempMat1.elements[0][3] = 0;
	tempMat1.elements[1][0] = 0;
	tempMat1.elements[1][1] = Math.cos(cameraRotation.elements[0]);
	tempMat1.elements[1][2] = Math.sin(cameraRotation.elements[0]);
	tempMat1.elements[1][3] = 0;
	tempMat1.elements[2][0] = 0;
	tempMat1.elements[2][1] = -Math.sin(cameraRotation.elements[0]);
	tempMat1.elements[2][2] = Math.cos(cameraRotation.elements[0]);
	tempMat1.elements[2][3] = 0;
	tempMat1.elements[3][0] = 0;
	tempMat1.elements[3][1] = 0;
	tempMat1.elements[3][2] = 0;
	tempMat1.elements[3][3] = 1;

	if (flag_debug_verbose == true) {
		console.log("  x axis rotation matrix: " + tempMat1.elements)
	};
	result = result.multiply(tempMat1);

	// rotation on y axis:
	tempMat2.elements[0][0] = Math.cos(cameraRotation.elements[1]);
	tempMat2.elements[0][1] = 0;
	tempMat2.elements[0][2] = -Math.sin(cameraRotation.elements[1]);
	tempMat2.elements[0][3] = 0;
	tempMat2.elements[1][0] = 0;
	tempMat2.elements[1][1] = 1;
	tempMat2.elements[1][2] = 0;
	tempMat2.elements[1][3] = 0;
	tempMat2.elements[2][0] = Math.sin(cameraRotation.elements[1]);
	tempMat2.elements[2][1] = 0;
	tempMat2.elements[2][2] = Math.cos(cameraRotation.elements[1]);
	tempMat2.elements[2][3] = 0;
	tempMat2.elements[3][0] = 0;
	tempMat2.elements[3][1] = 0;
	tempMat2.elements[3][2] = 0;
	tempMat2.elements[3][3] = 1;

	if (flag_debug_verbose == true) {
		console.log("  y axis rotation matrix: " + tempMat2.elements)
	};
	result = result.multiply(tempMat2);

	// rotation on z axis:
	tempMat3.elements[0][0] = Math.cos(cameraRotation.elements[2]);
	tempMat3.elements[0][1] = Math.sin(cameraRotation.elements[2]);
	tempMat3.elements[0][2] = 0;
	tempMat3.elements[0][3] = 0;
	tempMat3.elements[1][0] = -Math.sin(cameraRotation.elements[2]);
	tempMat3.elements[1][1] = Math.cos(cameraRotation.elements[2]);
	tempMat3.elements[1][2] = 0;
	tempMat3.elements[1][3] = 0;
	tempMat3.elements[2][0] = 0;
	tempMat3.elements[2][1] = 0;
	tempMat3.elements[2][2] = 1;
	tempMat3.elements[2][3] = 0;
	tempMat3.elements[3][0] = 0;
	tempMat3.elements[3][1] = 0;
	tempMat3.elements[3][2] = 0;
	tempMat3.elements[3][3] = 1;

	if (flag_debug_verbose == true) {
		console.log("  z axis rotation matrix: " + tempMat3.elements)
	};
	result = result.multiply(tempMat3);

	// calculate inverse translation
	tempMat4.elements[0][0] = 1;
	tempMat4.elements[0][1] = 0;
	tempMat4.elements[0][2] = 0;
	tempMat4.elements[0][3] = -cameraPosition.elements[0];
	tempMat4.elements[1][0] = 0;
	tempMat4.elements[1][1] = 1;
	tempMat4.elements[1][2] = 0;
	tempMat4.elements[1][3] = -cameraPosition.elements[1];
	tempMat4.elements[2][0] = 0;
	tempMat4.elements[2][1] = 0;
	tempMat4.elements[2][2] = 1;
	tempMat4.elements[2][3] = -cameraPosition.elements[2];
	tempMat4.elements[3][0] = 0;
	tempMat4.elements[3][1] = 0;
	tempMat4.elements[3][2] = 0;
	tempMat4.elements[3][3] = 1;

	if (flag_debug_verbose == true) {
		console.log("  translation matrix: " + tempMat4)
	};
	...
	if (flag_debug_verbose == true) {
		console.log("  camera transform matrix: " + cameraTransform.elements)
	};

	if (flag_debug == true) {
		console.log("leaving buildCameraTransform()")
	};
...
function worldSpaceTransform() {
	if (flag_debug == true) {
		console.log("entering worldSpaceTransform()")
	};
	// tempMat1: x, tempMat2: y, tempMat3: z, tempMat4: translation
	...
	for (index = 0; index < totalCubes; index++) // for all objects:
	{
		...
		tempMat4.elements[0][1] = 0;
		tempMat4.elements[0][2] = 0;
		tempMat4.elements[0][3] = -cubes[index].position.x;
		tempMat4.elements[1][0] = 0;
		tempMat4.elements[1][1] = 1;
		tempMat4.elements[1][2] = 0;
		tempMat4.elements[1][3] = -cubes[index].position.y;
		tempMat4.elements[2][0] = 0;
		tempMat4.elements[2][1] = 0;
		tempMat4.elements[2][2] = 1;
		tempMat4.elements[2][3] = -cubes[index].position.z;
		tempMat4.elements[3][0] = 0;
		tempMat4.elements[3][1] = 0;
		tempMat4.elements[3][2] = 0;
		tempMat4.elements[3][3] = 1;
		...
		if (flag_debug_verbose == true) {
			console.log("  translation matrix: " + tempMat4.elements)
		};
		result = result.multiply(tempMat4);
		...
		tempMat1.elements[0][3] = 0;
		tempMat1.elements[1][0] = 0;
		tempMat1.elements[1][1] = Math.cos(cubes[index].rotation.x);
		tempMat1.elements[1][2] = -Math.sin(cubes[index].rotation.x);
		tempMat1.elements[1][3] = 0;
		tempMat1.elements[2][0] = 0;
		tempMat1.elements[2][1] = Math.sin(cubes[index].rotation.x);
		tempMat1.elements[2][2] = Math.cos(cubes[index].rotation.x);
		tempMat1.elements[2][3] = 0;
		tempMat1.elements[3][0] = 0;
		tempMat1.elements[3][1] = 0;
		tempMat1.elements[3][2] = 0;
		...
		// rotation on y axis:
		tempMat2.elements[0][0] = Math.cos(cubes[index].rotation.y);
		tempMat2.elements[0][1] = 0;
		tempMat2.elements[0][2] = Math.sin(cubes[index].rotation.y);
		tempMat2.elements[0][3] = 0;
		tempMat2.elements[1][0] = 0;
		tempMat2.elements[1][1] = 1;
		tempMat2.elements[1][2] = 0;
		tempMat2.elements[1][3] = 0;
		tempMat2.elements[2][0] = -Math.sin(cubes[index].rotation.y);
		tempMat2.elements[2][1] = 0;
		tempMat2.elements[2][2] = Math.cos(cubes[index].rotation.y);
		tempMat2.elements[2][3] = 0;
		tempMat2.elements[3][0] = 0;
		tempMat2.elements[3][1] = 0;
		tempMat2.elements[3][2] = 0;
		...
		// rotation on z axis:
		tempMat3.elements[0][0] = Math.cos(cubes[index].rotation.z);
		tempMat3.elements[0][1] = -Math.sin(cubes[index].rotation.z);
		tempMat3.elements[0][2] = 0;
		tempMat3.elements[0][3] = 0;
		tempMat3.elements[1][0] = Math.sin(cubes[index].rotation.z);
		tempMat3.elements[1][1] = Math.cos(cubes[index].rotation.z);
		tempMat3.elements[1][2] = 0;
		tempMat3.elements[1][3] = 0;
		tempMat3.elements[2][0] = 0;
		tempMat3.elements[2][1] = 0;
		...
		if (flag_debug_verbose == true) {
			console.log("  world transform matrix: " + worldTransform.elements)
		};
	...
	if (flag_debug == true) {
		console.log("  applied to verts")
	};
	if (flag_debug == true) {
		console.log("leaving worldSpaceTransform()")
	};
...
function calculateBackFaces() {
	if (flag_debug == true) {
		console.log("entering calculateBackFaces()")
	};
	...
	for (index = 0; index < totalCubes; index++) // for all objects:
	{
		for (index2 = 0; index2 < 12; index2++) // for all polygons:
		{
			...
			if (tempVert1.dot(eyeVector) <= 0) {
				cubes[index].polygon[index2].active = true
			} else {
				cubes[index].polygon[index2].active = false
			};
			...
			if (flag_debug_verbose == true) {
				console.log("  object: " + index + " polygon: " + index2 + " set: " + cubes[index].polygon[index2].active)
			};
		}
	}

	if (flag_debug == true) {
		console.log("leaving calculateBackFaces()")
	};
}
...
function cameraSpaceTransform() {
	if (flag_debug == true) {
		console.log("entering cameraSpaceTransform()")
	};
	...
	if (flag_debug == true) {
		console.log("leaving cameraSpaceTransform()")
	};
...
function projectionSpaceTransform() {
	if (flag_debug == true) {
		console.log("entering projectionSpaceTransform()")
	};
	...
	if (flag_debug == true) {
		console.log("leaving projectionSpaceTransform()")
	};
...
function deHomogenise() {
	if (flag_debug == true) {
		console.log("entering deHomogenise()")
	};
	...
	if (flag_debug == true) {
		console.log("leaving deHomogenise()")
	};
...
function screenSpaceTransform() {
	if (flag_debug == true) {
		console.log("entering screenSpaceTransform()")
	};
	...
	if (flag_debug == true) {
		console.log("leaving screenSpaceTransform()")
	};
...
function animate() {
	...
	if (running) requestAnimationFrame(animate); // tell browser to render, when running
	...
	if (flag_debug == true) {
		console.log("looping animate()")
	};

	if (flag_trigger_debugger == true) {
		debugger;
	}
}

// requestAnim polyfill layer by Paul Irish
// http://www.paulirish.com/2011/requestanimationframe-for-smart-animating/
// https://gist.github.com/paulirish/1579671 (MIT license)
...
function update() {
	...
	rotation += 0.005;
	cameraRotation.elements[0] = -(Math.sin(rotation) * 0.6); // X
	cameraRotation.elements[1] = Math.sin(rotation * 2.0) * 0.75; // Y
	cameraRotation.elements[2] = Math.sin(rotation * 2.0) * 0.45; // Z
	cameraPosition.elements[0] = Math.sin(rotation * 2.0) * 8000.0; // X
	cameraPosition.elements[1] = Math.sin(rotation) * 20000.0; // Y
	cameraPosition.elements[2] += Math.sin(rotation * 2.0) * 200.0; // Z

	if (rotation >= 6.28318530717958647692) {
		rotation = 0;
	}
...
function resizeCanvas() {
	if (flag_debug == true) {
		console.log("      entering resizeCanvas()")
	};
	...
	if (flag_debug == true) {
		console.log("          canvas is now " + viewportWidth + "x" + viewportHeight)
	};
	if (flag_debug_verbose == true) {
		console.log("          projection matrix is now " + perspectiveTransform.elements)
	};
	if (flag_debug_verbose == true) {
		console.log("          screen matrix is now " + screenTransform.elements)
	};
	if (flag_debug == true) {
		console.log("      leaving resizeCanvas()")
	};
	if (flag_trigger_debugger_verbose == true) {
		debugger;
	}
